...
const PediatricVisitNotes: React.FC = () => {
  const [visits, setVisits] = useState<PediatricVisit[]>([
    {
      id: '1',
      date: '2024-01-15',
      doctor: 'Dr. Sarah Johnson',
      reason: 'Newborn checkup',
      weight: 3.2,
      height: 50,
      headCircumference: 35,
      diagnosis: 'Healthy newborn',
      prescriptions: 'Vitamin D drops',
      notes: 'Baby is healthy and meeting all milestones. Continue breastfeeding.',
  ...
  const addVisit = () => {
    ...
    const visit: PediatricVisit = {
      ...
      headCircumference: formData.headCircumference ? parseFloat(formData.headCircumference) : 0,
  ...
  const updateVisit = () => {
    ...
    const updatedVisit: PediatricVisit = {
      id: editingId,
      date: formData.date,
      doctor: formData.doctor,
      reason: formData.reason,
    ...
    setVisits(prev => prev.map(v => v.id === editingId ? updatedVisit : v));
    setEditingId(null);
    resetForm();
  };
  ...
  const editVisit = (visit: PediatricVisit) => {
    setFormData({
      date: visit.date,
      doctor: visit.doctor,
      reason: visit.reason,
      ...
      headCircumference: visit.headCircumference.toString(),
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    placeholder="Healthy, common cold, etc."
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
                    rows={2}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
                    rows={3}
                    placeholder="Observations, recommendations, follow-up instructions..."
                  />
                </div>
                ...
                <button
                  onClick={editingId ? updateVisit : addVisit}
                  className="w-full bg-gradient-to-r from-bloomPink to-bloomYellow text-white py-3 rounded-2xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="p-2 hover:bg-white rounded-lg transition-colors text-gray-600 hover:text-indigo-600"
                        >
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <div className="text-sm text-gray-600 space-y-1">
                            ...
                            {visit.nextVisit && (
                              <div><strong>Next Visit:</strong> {new Date(visit.nextVisit).toLocaleDateString()}</div>
                            )}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-3 gap-2 text-sm">
                            <div className="text-center p-2 bg-white rounded-lg border">
                              <div className="font-semibold text-gray-800">{visit.weight} kg</div>
                              <div className="text-gray-600">Weight</div>
                            </div>
                            <div className="text-center p-2 bg-white rounded-lg border">
                              <div className="font-semibold text-gray-800">{visit.height} cm</div>
                              <div className="text-gray-600">Height</div>
                            </div>
                            <div className="text-center p-2 bg-white rounded-lg border">
                              <div className="font-semibold text-gray-800">{visit.headCircumference} cm</div>
