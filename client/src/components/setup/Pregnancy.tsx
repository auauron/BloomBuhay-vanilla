...
export default function Pregnancy({ onComplete }: PregnancyProps) {
 ...
 return (
  <div className="bg-bloomWhite min-h-screen flex flex-col">
    <SetupHeader />
    <div className="flex-1 flex justify-start px-6 mt-4">
      <div style={{ maxWidth: "900px" }} className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">

          {/* left column */}
          <div className="space-y-6 text-left">
            <h2 className="text-bloomBlack font-semibold whitespace-nowrap">
              How many weeks pregnant are you?
            </h2>

            <div className="radio-btn space-y-4">
              ...
              <label className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-bloomBlack whitespace-nowrap">
          ...
          {/* right column */}
          <div className="space-y-6 text-left">
            <div className="baby-details space-y-4">
              <div>
                <h2 className="font-semibold text-bloomBlack whitespace-nowrap">
            ...
            <div>
              ...
              <div className="relative mt-2 w-72" ref={dropdownRef}>
                <button
        ...
        <div className="flex justify-start mt-8">
          <NextButton onComplete={handleNext} isReady={weeksOrLmpFilled} />
        </div>
      </div>
    </div>
  </div>
