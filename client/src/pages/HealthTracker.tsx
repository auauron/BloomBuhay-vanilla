...
export default function HealthTracker() {
  ...
  const [healthMetrics, setHealthMetrics] = useState([
    { title: "Weight", value: "62 kg", change: "+1.2 kg", trend: "up", icon: "⚖️", color: "from-bloomPink to-[#F5ABA1]" },
    { title: "Blood Pressure", value: "110/70", change: "Stable", trend: "stable", icon: "❤️", color: "from-bloomPink to-bloomYellow" },
    { title: "BMI", value: "23.4", change: "Healthy", trend: "stable", icon: "📊", color: "from-[#F5ABA1] to-[#F3E198]" },
    { title: "Water Intake", value: "2.1 L", change: "-0.3 L", trend: "down", icon: "💧", color: "from-bloomPink to-[#F5ABA1]" },
  ]);
